    ...
    return (
        <div className="Home">
            <div className="Home__container">
                ...
                <div><button className={`Home__prep ${next === true ? "" : "Home__display-none"}`}><Link className="Home__prep-link" to="/preparation">INTAKE</Link></button></div>
            ...
            <button className="Home__edit"><Link to="/edit" className="Home__link">EDIT</Link></button>
        </div>
    );
}
